class ViewerUtility {
    ...
    static async createDebugCube(viewer,pos, scale = 0.3, color  = new Communicator.Color(255,0,0), flush = false)
    {
        ...
        // let cubenode2 = await viewer.model.createMeshInstance(myMeshInstanceData, ttt);
        // let cubenode3 = await viewer.model.createMeshInstance(myMeshInstanceData, ttt);
        // let cubenode4 = await viewer.model.createMeshInstance(myMeshInstanceData, ttt);
        // let mat2 = new Communicator.Matrix();
        // mat2.setTranslationComponent(0,0,40);
        // hwv.model.setNodeMatrix(cubenode2, mat2);

        // let mat3 = new Communicator.Matrix();
        // mat3.setTranslationComponent(0,40,0);
        // hwv.model.setNodeMatrix(cubenode3, mat3);

        // let mat4 = new Communicator.Matrix();
        // mat4.setTranslationComponent(40,0,0);
        // hwv.model.setNodeMatrix(cubenode4, mat4);
